...
const Services = () => {
  return (
    <section className="bg-gradient-to-b from-gray-200 to bg-gray-100 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto" id="about">
        <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900 leading-8 ">
        ...
        <div className="flex flex-wrap ">
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg shadow-md ">
              ...
              <h2 className="text-xl leading-1 text-gray-900 font-medium title-font mb-2">
